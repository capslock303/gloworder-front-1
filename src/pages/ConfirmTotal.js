        ...
        <SafeAreaView>
          {
            !this.state.orderStatus ?
              ...
              <View>
                ...
                :
                <View>
                  <View style={{ flexDirection: 'column', justifyContent: 'center', marginTop: 75}}>
                    <Text style={{...styles.headers5, textAlign: 'center'}}>{this.state.quantity} {this.props.selectedDrink.liquor.toLowerCase()} {this.props.selectedOption.option.toLowerCase()} added to your order!</Text>
                  </View>
                  
                  <View style={{ flexDirection: 'column', justifyContent: 'center', marginTop: 50}}>
                    <Text style={{...styles.headers6Light, textAlign: 'center'}}>Hit "Place Order" below to finalize order, or add more drinks to the order with the "Add More Drinks" button</Text>
                  </View>
